...
<head>
	...
	<style type="text/css">
		...
		.other-score li:nth-child(1){
			background-color: #FFFF99;
		}
		.other-score li:nth-child(2){
			background-color: #99CCFF;
		}
		.other-score li:nth-child(3){
...
<body>
	...
	<div class="wrapper">
		...
		<div class="other-score">
			<ul>
				<li>
					<label class="other-rank">1</label>
					<label class="other-school">同济大学</label>
					<label class="other-fenshu">92.3分</label>
				</li>
				<li>
					<label class="other-rank">2</label>
					<label class="other-school">同济大学</label>
					<label class="other-fenshu">92.3分</label>
				</li>
				<li>
					<label class="other-rank">3</label>
					<label class="other-school">同济大学</label>
					<label class="other-fenshu">92.3分</label>
				</li>
				<li>
